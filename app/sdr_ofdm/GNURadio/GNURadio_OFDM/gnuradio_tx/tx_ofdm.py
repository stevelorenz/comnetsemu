...
class tx_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/supersonic/Desktop/gnuradio_tx/file_tx.txt', True)
        ...
        self.connect((self.digital_ofdm_tx_0, 0), (self.qtgui_time_sink_x_0_1, 0))
