...
def testTopo():
    ...
    client1 = net.addDockerHost('h2', dimage='sec_test', ip='10.0.0.2', cpuset_cpus="1", cpu_quota=25000)
    client2 = net.addDockerHost('h3', dimage='sec_test', ip='10.0.0.3', cpuset_cpus="0", cpu_quota=25000)
    client3 = net.addDockerHost('h4', dimage='sec_test', ip='10.0.0.4', cpuset_cpus="0", cpu_quota=25000)
    ...
    net.addLinkNamedIfce(s1, client2, bw=10, delay='1ms', use_htb=True)
