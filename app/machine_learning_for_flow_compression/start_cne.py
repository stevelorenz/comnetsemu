...
def testTopo():
    ...
    compressor = net.addDockerHost(
        "compressor", dimage="o2sc", ip="10.0.0.1/24", cpuset_cpus="1", cpu_quota=25000
    )
    decompressor = net.addDockerHost(
        "decompressor", dimage="o2sc", ip="10.0.0.2/24", cpuset_cpus="1", cpu_quota=25000
    )
    source_1 = net.addDockerHost(
        "source_1", dimage="o2sc", ip="10.0.0.11/24", cpuset_cpus="1", cpu_quota=25000
    )
    source_2 = net.addDockerHost(
        "source_2", dimage="o2sc", ip="10.0.0.12/24", cpuset_cpus="1", cpu_quota=25000
    )
    source_3 = net.addDockerHost(
        "source_3", dimage="o2sc", ip="10.0.0.13/24", cpuset_cpus="1", cpu_quota=25000
    )
